(function () {
  ...
  UploadController.$inject = ['$cordovaImagePicker'];

  function UploadController($cordovaImagePicker) {
    ...
    vm.upload = function () {
        ...
        ft.upload(myImg, encodeURI("http://52.211.100.116/upload/"), onUploadSuccess, onUploadFail, options);
    };
    vm.imageSrc = "";
    vm.select = function () {
      var options = {
